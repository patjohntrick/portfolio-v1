...
const Footer = () => {
  return (
    <footer className=" bg-black text-white py-10 ">
      <div className="footer-container px-5 text-center xs:flex xs:justify-between xs:text-left md:px-12 lg:w-[960px] lg:m-auto lg:p-0 xl:w-[1250px] 2xl:w-[1400px] ">
        <div className="logo-container mb-6  ">
          <p className=" uppercase font-black text-3xl ">pat.</p>
